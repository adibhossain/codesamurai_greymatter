...
<html lang="en">
  ...
  <script src="https://code.jquery.com/jquery-1.10.2.js"></script>
    ...
    <title>Proposed Project List</title>
  </head>
  <body>
    <!-- navbar starts -->
          ...
          <div class="col-xxl-3 col-12 mb-5">
            ...
            <div class="p-3 border bg-white border border-3  border-success">
              <div class="dropdown">
                  ...
                  >
                    <li>
                      <a class="dropdown-item" href="#">Proposed</a>
                    </li>
                      <a class="dropdown-item" href="index.php">Approved</a>
                    </li>
                  </ul>
              </div>
            </div>
                                  ...
                                  ><div class="p-3 mt-2 mb-2 border border border-2  border-success">
                                    ...
                                    <h6 class="inline-block">
                                      ...
                                      <div class="btn-group " role="group" aria-label="Basic example">
                                        <button type="button" class="btn btn-outline-success"><a class="text-decoration-none" href="approve_project.php">Accept</a></button>
