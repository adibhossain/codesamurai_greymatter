...
<title>Approve Project Form</title>
...
<div class="bg-light" >
  <div class="container" style="padding: 10px 10px 0px 0px;">
    <h2 style="text-align: left"><b>Approve Project Form:</b></h2>
  </div>
  ...
  <form class="row g-3 bg-white border p-3 border-1" style="border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);" action="" method="POST">      
      ...
      <div class="col-md-12">
        ...
        <h6>Actual Cost<font color="ff0000">*</font></h6>
        </label>
        <input type="text" required class="form-control" name="AlumniName" id="AlumniName" />
      </div>
      <div class="col-md-12"  >
        <label for="EnrollDate" class="form-label">
        <h6>Start Date<font color="ff0000">*</font></h6>
        <p class="hint-text">Suggested timeframe is:</p>
        </label>
      ...
      <div class="col-md-12">
        ...
        <h6>Completion<font color="ff0000">*</font></h6>
        </label>
